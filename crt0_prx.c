    ...
    if(!cheatSaved)
    {
      ...
      scounter=0;
        ...
        else
        {
          ...
          if(((address >= 0x08804000) && (address < 0x0A000000)) || ((address >= 0x48804000) && (address < 0x4A000000)))
          {
        		switch(block[counter].flags & FLAG_DWORD)
    		   	{
    		   		case FLAG_DWORD:
...
void menuDraw()
{
  ...
  pspDebugScreenPuts(cheatStatus ? "[CHEATS ARE ON]\n\n" : (!cheatSaved ? "[ALL CHEATS ARE OFF]\n\n" : "[CHEATS ARE OFF]\n\n"));
  
  //User friendly note
  if(lolInit)
  {
    pspDebugScreenSetTextColor(0xFFFFFFFF);pspDebugScreenPuts("[Welcome!]");
  ...
  {
    //Draw the tabs
    pspDebugScreenSetTextColor(tabSelected == 0? 0xFFFFFFFF: 0xFF808080); pspDebugScreenPuts("[Cheats List] ");
    pspDebugScreenSetTextColor(tabSelected == 1? 0xFFFFFFFF: 0xFF808080); pspDebugScreenPuts("[Searcher] ");
    pspDebugScreenSetTextColor(tabSelected == 2? 0xFFFFFFFF: 0xFF808080); pspDebugScreenPuts("[Mem View] ");
    pspDebugScreenSetTextColor(tabSelected == 3? 0xFFFFFFFF: 0xFF808080); pspDebugScreenPuts("[Decoder] ");
    pspDebugScreenSetTextColor(tabSelected == 4? 0xFFFFFFFF: 0xFF808080); pspDebugScreenPuts("[Tools] ");
    pspDebugScreenSetTextColor(tabSelected == 5? 0xFFFFFFFF: 0xFF808080); pspDebugScreenPuts("[Settings] ");
    pspDebugScreenSetTextColor(0xFF808080);pspDebugScreenPuts("\n--------------------------------------------------------------------");
  ...
  if(copyMenu)
  {
    pspDebugScreenSetXY(25, 15);
    	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c", 0xC9); pspDebugScreenPuts(buffer);
    	pspDebugScreenSetBackColor(0xFFFF0000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c", 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3); pspDebugScreenPuts(buffer);
    	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c", 0xC6); pspDebugScreenPuts(buffer);
    pspDebugScreenSetXY(25, 16); 
    	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c", 0xC9); pspDebugScreenPuts(buffer);
    	pspDebugScreenSetBackColor(0xFFFF0000); pspDebugScreenSetTextColor(0xFFFFFFFF); sprintf(buffer, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c",  0x20, 0x20, 0x20, '-',  0x20,  'C', 'o',  'p',  'i',  'e',  'r' ,  0x20, '-', 0x20, 0x20, 0x20); pspDebugScreenPuts(buffer);
      pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c", 0xC6); pspDebugScreenPuts(buffer);
    pspDebugScreenSetXY(25, 17);
    	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c", 0xC9); pspDebugScreenPuts(buffer);
    	pspDebugScreenSetBackColor(0xFFFF0000); pspDebugScreenSetTextColor(0xFFFFFFFF); sprintf(buffer, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c",  0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20); pspDebugScreenPuts(buffer);
      pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c", 0xC6); pspDebugScreenPuts(buffer);
    pspDebugScreenSetXY(25, 18); sprintf(buffer, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c", 0xC9, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC6); pspDebugScreenPuts(buffer);
  	pspDebugScreenSetXY(25, 19); 
    	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c%c", 0xC9, 0x20); pspDebugScreenPuts(buffer);
      pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); if(copyMenu==1) {  pspDebugScreenSetTextColor(0xFF0000FF); pspDebugScreenPuts(">"); } else { pspDebugScreenPuts(" ");}
    ...
    pspDebugScreenSetXY(25, 20); 
    	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c%c", 0xC9, 0x20); pspDebugScreenPuts(buffer);
      pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); if(copyMenu==2) {  pspDebugScreenSetTextColor(0xFF0000FF); pspDebugScreenPuts(">"); } else { pspDebugScreenPuts(" ");}
      pspDebugScreenSetBackColor(0xFF000000); sprintf(buffer, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c", 'P',  'a',  's',  't',  'e', 0x20,  'A',  'd',  'd',  'r',  'e',  's',  's', 0x20); pspDebugScreenPuts(buffer);
    	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "%c", 0xC6); pspDebugScreenPuts(buffer);
    pspDebugScreenSetXY(25, 21); sprintf(buffer, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c", 0xC9, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0xC6); pspDebugScreenPuts(buffer); 
    pspDebugScreenSetXY(25, 22); sprintf(buffer, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c", 0x20, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x20); pspDebugScreenPuts(buffer);
  	pspDebugScreenSetBackColor(0xFF000000); pspDebugScreenSetTextColor(0xFFFF8000);
  }
                  ...
                  while(counter < 0x4A000000)
                    ...
                    if(!((counter - 0x48804000) & 0xFFFF))
                    {
                      if(!cheatPause) sceKernelDelayThread(1500);
        							...
        							lineClear(33);
        							pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "Task = %02d%%; () = Hold to Abort", (counter-0x48804000)/((0x4A000000-0x48804000)/100)); pspDebugScreenPuts(buffer);
                  ...
                  while(counter > 0)
                  {
                    ...
                    if(!(counter & 0x3F))
                    {
                      if(!cheatPause) sceKernelDelayThread(1500);
        							...
        							lineClear(33);
        							pspDebugScreenSetTextColor(0xFFFF8000); sprintf(buffer, "Task = %02d%%; () = Hold to Abort", (scounter-0x48804000)/((0x4A000000-0x48804000)/100)); pspDebugScreenPuts(buffer);
